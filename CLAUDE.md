...
14. **Flex Fuel & Fuel System:** Continental ethanol sensor + Injector Dynamics ID725 (725cc) injectors + Acuity K-Series fuel rail + DeatschWerks DW300C (340 LPH) fuel pump. E85 adds 5-15 WHP on NA over pump gas (modest vs turbo). ID725 chosen as NA/turbo middle ground — good idle quality, headroom for future forced induction. Best value at E30-E40 blend. See 12-Flex-Fuel-and-Fuel-System/.
15. **Clutch Hydraulics:** Hybrid Racing HYB-CMC-01-20 complete kit (CMC + CSC + stainless braided clutch line + hardware) + Motul RBF 600 DOT 4 fluid. 170k-mile reliability upgrade — stock CMC/CSC are a known failure point. See 13-Clutch-Hydraulics/.
