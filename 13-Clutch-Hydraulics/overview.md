# Clutch Hydraulics Upgrade — 2009 Honda Civic SI (FG2 / K20Z3)
...
| Field | Value |
|-------|-------|
| Product | Hybrid Racing Clutch Master Upgrade for Accord/Civic/RSX/TSX |
| Part Number | HYB-CMC-01-20 |
| Price | $289.99 |
| Buy Link | [hybrid-racing.com](https://www.hybrid-racing.com/products/hybrid-racing-cmc-upgrade-acura-tsx) |
| Install Guide | [guides.hybrid-racing.com](https://guides.hybrid-racing.com/Guide/Hybrid+Racing+Clutch+Master+Cylinder+Upgrade+(06-11+Civic+Si)/8) |
| Fitment | 2006-2011 Honda Civic SI (FG2 coupe / FA5 sedan) — LHD only |

### What's Included in the Kit

- (1) Upgraded clutch master cylinder with clevis
- (1) Upgraded slave cylinder
- (1) Stainless steel braided clutch line with fittings
- (1) Firewall seal
...
|--------|---------|-------|-------|
| Best | Motive Products Power Bleeder | ~$50-70 | One-person operation, pressurizes reservoir |
| Good | Mityvac hand vacuum pump | ~$30-40 | One-person, pulls fluid from bleeder valve |
| Free | Two-person manual bleeding | $0 | One pumps pedal, one opens/closes bleeder |
...
- **60,000-100,000 miles** is the most commonly reported window for the first CMC failure on 8th gen SIs.
...
| Symptom | CMC (Master) | CSC (Slave) |
|---|---|---|
| Pedal slowly sinks to floor when held | Yes (classic sign) | No |
| Pedal is soft/spongy but stays in position | Could be either (air in system) | Could be either |
| Fluid on driver's side carpet or firewall | Yes — leaking past pushrod seal | No |
| Fluid weeping near transmission bellhousing | No | Yes |
| Reservoir level dropping with no visible leak | CMC internal bypass (most common) | Possible CSC internal leak |
| Clutch won't disengage after sitting in traffic | Yes — heat soak causing seal bypass | Less likely |
| Pedal feels fine cold, gets soft when hot | Yes — classic heat-related CMC failure | Less likely |
| Hard pedal / pedal won't return | Rare CMC issue (sticking piston) | More commonly a CSC issue or throwout bearing |

**The "parking lot test":** Pump the clutch pedal 15-20 times rapidly. If the engagement point drops noticeably and the pedal feels mushier, the CMC is bypassing internally.
...
## 2. Stock CMC/CSC Specifications

### OEM Part Numbers

**Clutch Master Cylinder (CMC):**
- **46920-SVA-A01** — Original part number (2006-2008 models, early production)
- **46920-SVA-A02** — Revised part number (later production and replacement)
- **46920-SVA-A03** — Further revised (current replacement part from Honda)
- Approximate dealer price: $80-$120

**Clutch Slave Cylinder (CSC):**
- **46930-SVA-A01** — Original
...
- **Upgraded CMC** — OE genuine JDM master cylinder with better seals, better bore finish, and proven longevity
- **Upgraded CSC** — Included in the kit, no need to source separately
- **Stainless steel braided clutch line** — Replaces the stock rubber line that swells under pressure. PTFE inner liner doesn't expand = 100% of pedal force reaches the CSC
- **All hardware** — Banjo fittings, crush washers, firewall seal, mounting clips, PTFE grease
- **Direct bolt-on** — No adapter bracket fabrication, no drilling, no guesswork

### Community Reception

- **8thcivic.com** forum: Hundreds of positive install reports. Considered the gold standard upgrade.
- **Reddit r/CivicSi**: Frequently recommended as "the first thing you should do" on an 8th gen SI.
...
Hybrid Racing provides a dedicated install guide for the 06-11 Civic SI:
**[guides.hybrid-racing.com — CMC Upgrade (06-11 Civic Si)](https://guides.hybrid-racing.com/Guide/Hybrid+Racing+Clutch+Master+Cylinder+Upgrade+(06-11+Civic+Si)/8)**
...
3. From inside the cabin, disconnect CMC pushrod from clutch pedal (clevis pin with cotter pin).
4. Remove two mounting bolts on firewall.
5. Pull CMC out through engine bay.

**CMC Installation:**
1. Bench bleed the new CMC before installing (critical — see below).
2. Insert new CMC, attach pushrod to pedal.
3. Bolt to firewall, connect clutch line.

**CSC Swap:**
1. CSC is bolted to outside of transmission bellhousing (accessible from under the car).
2. Disconnect line, remove two bolts, swap CSC.
3. Torque to ~16 ft-lbs.

**Clutch Line:**
1. Remove entire OEM line (CMC to CSC).
2. Route new SS braided line, secure with zip ties or P-clamps away from exhaust.

### Bench Bleeding (Critical Step)

1. Clamp new CMC in vise with soft jaws.
2. Fill reservoir with Motul RBF 600.
3. Use bench bleed kit (short hoses looping output back to reservoir).
4. Slowly push piston in and release — 20-30 times until no bubbles.
5. Cap output port, install immediately.

### Bleeding the Installed System

1. Fill CMC reservoir to MAX with fresh Motul RBF 600.
2. Bleed at CSC bleeder valve (furthest point from CMC).
3. **Pressure bleeder method:** Attach to reservoir, pressurize to 10-15 PSI, open bleeder, let fluid flow until clear with zero bubbles.
4. **Manual method:** Helper pumps pedal 3-4 times, holds down. Open bleeder to release fluid/air. Close bleeder. Release pedal. Repeat.
5. Pump clutch pedal 20-30 times — should be firm with consistent engagement point.
...
- **New crush washers every time** you disconnect a banjo bolt.
- **The clevis pin under the dash is fiddly.** Small flashlight + magnetic pickup tool helps.
- **Second bleed after 1 week of driving** is good practice — lets micro-air work out.
...
- [ ] Flush clutch fluid every 2 years / 30,000 miles with fresh Motul RBF 600
- [ ] Visually inspect CMC reservoir level at every oil change
- [ ] Check for leaks at CMC, CSC, and all line fittings annually
- [ ] If the pedal ever feels different, bleed the system immediately
