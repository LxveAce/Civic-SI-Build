...
## 01 — Clutch & Flywheel (Exedy Stage 1 + Lightweight Flywheel)

**Status: Installed**

- YouTube Search: `Exedy clutch install 8th gen Civic SI K20Z3`
- YouTube Search: `K20Z3 clutch replacement 8th gen Civic SI flywheel`

---

## 02 — Intake (K&N Typhoon 69-1014TS)

**Status: Installed**

- YouTube Search: `K&N Typhoon 69-1014TS install 8th gen Civic SI`

---

## 03 — Short Shifter + Bushings (Acuity)

**Status: Installed**

- YouTube Search: `Acuity short shifter install 8th gen Civic SI`
- YouTube Search: `Acuity shifter cable bushings install Civic SI`

---

## 04 — Engine Mounts (Hybrid Racing 70A)

**Status: Purchased, Awaiting Install**

- YouTube Search: `engine mount install 8th gen Civic SI Hybrid Racing Hasport 70A`
- YouTube Search: `K20Z3 motor mount replacement 8th gen Civic`

---

## 05 — Brakes (Hawk HPS + R1 Concepts Rotors)
...
### Key Notes
- **Bed the Hawk HPS pads properly.** Follow Hawk's bedding procedure: 6-10 moderate stops from 35 mph, then 2-3 harder stops from 45 mph, then drive 5 minutes without heavy braking to cool.
- Front caliper bolts: 19mm. Rear caliper bolts: 12mm.
- Pump brake pedal several times after install until pedal pressure returns.
- Check master cylinder fluid level after compressing pistons.

---

## 06 — Strut Bar (Megan Racing MR-SB-HC06FU-1P)
...
**Status: Purchased, Awaiting First Flash**

### Written Guides
- [Hondata Official — FlashPro Civic Si 2006-2011](https://hondata.com/flashpro-civic-si-2006-2011-us)
- [9thgencivic.com — Hondata FlashPro for Noobs](https://www.9thgencivic.com/threads/how-to-hondata-flashpro-for-noobs.143985/) (process is similar for 8th gen)

### First Flash Steps
1. Install FlashProManager on a Windows PC
2. Plug in FlashPro via USB, fill out registration, register with Hondata
3. Take FlashPro to car, plug into OBD2, turn ignition ON (don't start) for 5 seconds to record VIN
4. Back at PC: select "Online, Lock" and choose a calibration (start with stock + intake base map)
5. Upload calibration to FlashPro
...
## 08 — Valved Exhaust (QTP QTEC30 3")
...
## 09 — Headers (Skunk2 Alpha 412-05-1930 + Berk HFC)

**Status: Planned**

### Written Guides
- [Hybrid Racing — Skunk2 Alpha Header Install (06-11 Civic Si)](https://guides.hybrid-racing.com/Guide/Skunk2+Alpha+Header+(06-11+Civic+Si)/32)
- [8thcivic.com — Recent Skunk2 Alpha Header Install Tips and Q&A](https://www.8thcivic.com/threads/recent-skunk2-alpha-header-install-tips-and-some-q-a.587577/)
...
## 10 — Intake Manifold (Skunk2 Ultra Street 307-05-0600)
...
## 11 — Pulleys (ATI Super Damper 918477 + NST Kit)
...
## 13 — Clutch Hydraulics (Hybrid Racing HYB-CMC-01-20)
...
### Install Overview
**Difficulty: Moderate. 3-5 hours. Access is tight.**

#### What the Kit Includes (HYB-CMC-01-20)
...
8. **Install new CSC:** Remove transmission inspection plate to access the slave cylinder. Swap old CSC for new one.
9. **Install braided line:** Route the new stainless braided clutch line from CMC to CSC
10. **Fill and bleed:** Fill reservoir with **Motul RBF 600** brake fluid. Bleed the system thoroughly — gravity bleed or pressure bleed. Air bubbles = spongy pedal.
11. **Test:** Pump clutch pedal multiple times. Should feel firm with consistent engagement point. Road test through all gears.
...
## 14 — Suspension (BC Racing BR + Full Overhaul)

**Status: Planned**

### Written Guides — Coilover Install
- [8thcivic.com — DIY: Installing Coilovers on 8th Gen Civics](https://www.8thcivic.com/threads/diy-installing-standard-suspension-coilovers-on-8th-gen-civics.269770/)
- [8thcivic.com — Full Coilover Install Tips/Tricks](https://www.8thcivic.com/threads/full-coilover-install-tips-tricks-please.95589/)
- [8thcivic.com — MaXpeedingRods Coilover Installation Guide](https://www.8thcivic.com/threads/maxpeedingrods-coilover-installation-guide.658663/) (process applies to any coilover)
- [vtec.academy — 8th Gen Civic Coilover Install](https://vtec.academy/8th-gen-civic-coilover-install/)
- [civicforums.com — How to Install Coilovers on the 8th Gen Honda Civic](https://www.civicforums.com/forums/95-retail-sales-site-vendor-annoucements/383499-how-install-coilovers-8th-gen-honda-civic.html)

### Written Guides — Bushings
- [8thcivic.com — Energy Suspension Bushing Kit, Front Bushing on Rear Trailing Arm Install](https://www.8thcivic.com/threads/energy-suspension-bushing-kit-front-bushing-on-rear-trailing-arm-install.610098/)
- [8thcivic.com — Suspension Bushings Replacement Options](https://www.8thcivic.com/threads/suspension-bushings-replacement-options.657245/)

### YouTube Searches
- `BC Racing BR coilover install 8th gen Civic SI FG2`
- `coilover install 8th gen Civic SI front rear`
- `rear camber arm install 8th gen Civic SI Skunk2 Godspeed`
- `sway bar install 8th gen Civic SI Progress`
- `polyurethane bushing install 8th gen Civic`
- `rear trailing arm bushing replacement Honda Civic`
- `ball joint replacement 8th gen Honda Civic`
- `tie rod end replacement Honda Civic`
- `roll center adjuster install lowered Civic`
...
- **BrenTuning** — Hondata/tuning content
- **SpeedFactory Racing** — K-series builds
- **BriansMobile1** — Thorough Civic SI tutorials
